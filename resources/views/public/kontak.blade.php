    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div class="bg-white p-10 md:p-12 rounded-[2.5rem] shadow-2xl border border-slate-100 relative overflow-hidden">
                ...
                <form method="POST" action="{{ route('kontak.store') }}" class="space-y-6 relative z-10">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea name="pesan" rows="4" required
                            class="mt-2 w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-4 focus:ring-4 focus:ring-amber-400/20 focus:border-amber-400 focus:outline-none transition-all resize-none">{{ old('pesan') }}</textarea>
                    </div>
