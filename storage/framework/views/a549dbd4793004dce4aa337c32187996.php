    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors group">
                            <td class="p-4 text-xs font-bold text-slate-400 text-center"><?php echo e($index + 1); ?></td>
                            <td class="p-4">
                                <span class="text-sm font-bold text-slate-700 group-hover:text-blue-600 transition-colors"><?php echo e($cat->name); ?></span>
                            </td>
                            <td class="p-4">
                                <div class="flex items-center justify-center gap-2">
                                    <button onclick="editCategory(<?php echo e($cat->id); ?>, '<?php echo e($cat->name); ?>')" 
                                    ...
                                    <form action="<?php echo e(route('admin.categories.destroy', $cat->id)); ?>" method="POST" onsubmit="return confirm('Hapus kelompok ini?')">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-[2rem] border border-slate-100 shadow-sm p-8 sticky top-24">
                ...
                <form id="categoryForm" action="<?php echo e(route('admin.categories.store')); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
