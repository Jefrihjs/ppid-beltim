        ...
        <div class="lg:col-span-2">
            <div class="space-y-4">
                ...
                <div class="p-5 bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md transition flex justify-between items-start">
                    <div class="max-w-[85%]">
                        <span class="text-[9px] font-black text-amber-600 uppercase tracking-widest"><?php echo e($item->created_at->format('d M Y')); ?></span>
                        <h4 class="text-sm font-black text-slate-800 uppercase mt-1"><?php echo e($item->title); ?></h4>
                        <p class="text-xs text-slate-500 mt-2 line-clamp-2"><?php echo e($item->content); ?></p>
                    </div>
                    <a href="<?php echo e(route('admin.announcement.edit', $item->id)); ?>" class="text-amber-500 hover:text-amber-700 p-2 transition">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                    </a>
                    <form action="<?php echo e(route('admin.announcement.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Hapus pengumuman ini?')">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/announcement/index.blade.php ENDPATH**/ ?>