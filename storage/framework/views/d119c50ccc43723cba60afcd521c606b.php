    ...
    <div class="swiper heroSwiper">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide relative">
                <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('<?php echo e(asset('storage/images/' . $slide->image)); ?>')"></div>
...
<div x-data="{ scrolled: false }" 
    ...
    <div :class="scrolled ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'"
        ...
        <form action="<?php echo e(route('public.search')); ?>" method="GET" class="bg-white rounded-[2.5rem] p-2 shadow-2xl flex items-center border border-slate-100 shadow-blue-900/10">
    ...
    <<div :class="scrolled ? 'translate-y-0 opacity-100' : 'translate-y-40 opacity-0'"
     class="max-w-7xl mx-auto px-6 mt-12 transition-all duration-1000 ease-out transform delay-100 flex justify-center"> 
    
    
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 w-full justify-items-center">
        
        
        <a href="<?php echo e(route('permohonan.informasi')); ?>" class="w-full p-8 bg-white rounded-[3rem] shadow-xl hover:shadow-2xl transition-all text-center group border border-slate-50">
        ...
        <a href="<?php echo e(route('keberatan.form')); ?>" class="w-full p-8 bg-white rounded-[3rem] shadow-xl hover:shadow-2xl transition-all text-center group border border-slate-50">
        ...
        <a href="<?php echo e(route('sengketa.form')); ?>" class="w-full p-8 bg-white rounded-[3rem] shadow-xl hover:shadow-2xl transition-all text-center group border border-slate-50">
        ...
        <a href="<?php echo e(route('monitoring.form')); ?>" class="w-full p-8 bg-white rounded-[3rem] shadow-xl hover:shadow-2xl transition-all text-center group border border-slate-50">
    ...
    <div class="max-w-7xl mx-auto px-6 relative">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            ...
            <div class="group relative pt-6 md:pt-0">
                <div class="relative z-10 w-24 h-24 mx-auto flex items-center justify-center rounded-[2.5rem] <?php echo e($step['color']); ?> text-white shadow-2xl transition-all duration-500 group-hover:scale-110 group-hover:rotate-6 ring-8 ring-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo e($step['icon']); ?>" />
                    </svg>
                ...
                <div class="mt-8 bg-white/80 backdrop-blur-sm p-8 rounded-[2.5rem] shadow-sm border border-slate-100 transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-blue-200 group-hover:-translate-y-2 text-center h-full">
                    <h3 class="font-black text-slate-800 uppercase tracking-tight text-sm"><?php echo e($step['title']); ?></h3>
                    <p class="mt-4 text-sm text-slate-500 leading-relaxed font-medium italic"><?php echo e($step['desc']); ?></p>
                </div>
            </div>
        ...
        <div class="grid lg:grid-cols-12 gap-12 items-start">
                ...
                <div class="bg-white p-4 rounded-[3rem] shadow-xl border border-slate-100">
                    <div class="relative aspect-video rounded-[2.5rem] overflow-hidden bg-slate-900 shadow-inner">
                        ...
                        <iframe class="w-full h-full" 
                            src="https://www.youtube.com/embed/<?php echo e($mainVideo->youtube_id ?? 'dQw4w9WgXcQ'); ?>" 
            ...
            <div x-data="{ open: false, imgSrc: '', caption: '' }" class="lg:col-span-5 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <?php $__empty_1 = true; $__currentLoopData = $galleries->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="group relative aspect-square rounded-[2rem] overflow-hidden cursor-pointer shadow-md hover:shadow-xl transition-all duration-500 border-4 border-white"
                            ...
                            <img src="<?php echo e(asset('storage/' . $foto->image_path)); ?>" 
                                class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                                alt="<?php echo e($foto->caption); ?>">
                ...
                <?php if($galleries->count() > 2): ?>
                    <div class="mt-6 flex justify-start">
                        <a href="<?php echo e(route('public.gallery')); ?>" 
...
<section class="bg-white py-24 relative overflow-hidden">
    ...
    <div class="max-w-6xl mx-auto px-6 relative text-center">
        ...
        <div class="grid md:grid-cols-2 gap-8 lg:gap-12 text-left">
            ...
            <a href="<?php echo e(url('/permohonan')); ?>" class="group relative bg-slate-50 rounded-[2.5rem] p-10 transition-all hover:bg-slate-900 hover:shadow-2xl hover:-translate-y-2 overflow-hidden">
            ...
            <a href="<?php echo e(url('/monitoring')); ?>" class="group relative bg-slate-50 rounded-[2.5rem] p-10 transition-all hover:bg-red-600 hover:shadow-2xl hover:-translate-y-2 overflow-hidden">
...
<div x-data="{ open: true }" x-show="open" 
    ...
    <div class="relative bg-white p-2 rounded-[2.5rem] shadow-[0_20px_50px_rgba(220,38,38,0.3)] border-2 border-red-100 overflow-hidden group">
        ...
        <div class="overflow-hidden rounded-[2rem]">
            <img src="<?php echo e(asset('storage/' . $floating->image)); ?>" 
                 class="w-full h-auto object-cover transform transition-transform duration-700 group-hover:scale-110" 
                 alt="<?php echo e($floating->title); ?>">
        </div>

        <div class="p-4 text-center">
            <span class="text-[8px] font-black text-red-600 uppercase tracking-[0.2em] animate-pulse block mb-1">Himbauan Darurat</span>
            <p class="text-[10px] font-extrabold text-slate-800 leading-tight uppercase mb-3"><?php echo e($floating->title); ?></p>
            
            
            <a href="<?php echo e(route('public.prosedur')); ?>" class="block w-full py-2 bg-slate-900 text-white text-[9px] font-black uppercase tracking-widest rounded-xl hover:bg-red-600 transition-colors">
                Baca Selengkapnya
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/public/home.blade.php ENDPATH**/ ?>