...
<?php if(auth()->user()->role === 'superadmin'): ?>
    <div class="mt-6 pt-4 border-t border-slate-100">
        ...
        <a href="<?php echo e(route('admin.users.index')); ?>" 
           class="flex items-center gap-3 px-4 py-3 rounded-xl transition <?php echo e(request()->routeIs('admin.users.*') ? 'bg-red-600 text-white shadow-lg shadow-red-200' : 'text-slate-600 hover:bg-red-50 hover:text-red-600'); ?>">
