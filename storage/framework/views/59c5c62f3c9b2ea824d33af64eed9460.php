...
<div class="p-8 max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-8">
        <a href="<?php echo e(route('admin.informasi.index')); ?>" class="p-3 bg-white rounded-xl border border-slate-100 shadow-sm text-slate-400 hover:text-slate-900 transition-all">
    ...
    <form action="<?php echo e(route('admin.informasi.store')); ?>" method="POST" class="bg-white rounded-[2.5rem] border border-slate-100 shadow-xl p-10">
        <?php echo csrf_field(); ?>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
                ...
                <select id="select-sub-judul" name="id_kel" placeholder="Cari atau pilih kelompok...">
                    ...
                    <?php $__currentLoopData = $sub_juduls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/informasi/create.blade.php ENDPATH**/ ?>