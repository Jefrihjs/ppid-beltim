            ...
            <div class="bg-amber-50 p-8 rounded-[2rem] border border-amber-100 flex flex-col md:flex-row items-center gap-6">
                ...
                <div>
                    ...
                    <p class="text-slate-600 text-sm mt-1 leading-relaxed font-medium">
                        ...
                        <span class="block mt-2 font-bold text-slate-400 text-[10px] tracking-widest uppercase italic">Update: <?php echo e(date('d F Y')); ?></span>
                    </p>
                </div>
            </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/terms-conditions.blade.php ENDPATH**/ ?>