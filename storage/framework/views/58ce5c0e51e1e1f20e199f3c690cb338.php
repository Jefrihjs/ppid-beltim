...
<div class="p-8">
    ...
    <nav class="flex text-sm text-slate-500 mb-4 gap-2 italic">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="hover:text-blue-600">Beranda</a>
        <span>/</span>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
        ...
        <div class="bg-white p-8 rounded-xl shadow-sm border border-slate-50 flex flex-col items-center text-center group hover:shadow-md transition">
            <div class="relative mb-4">
                ...
                <span class="absolute -top-2 -right-2 bg-emerald-400 text-white text-[10px] font-black w-6 h-6 flex items-center justify-center rounded-full border-2 border-white"><?php echo e($stats['baru']); ?></span>
            </div>
            <h3 class="text-3xl font-black text-emerald-400"><?php echo e($stats['baru']); ?></h3>
        ...
        <div class="bg-white p-8 rounded-xl shadow-sm border border-slate-50 flex flex-col items-center text-center group hover:shadow-md transition">
            ...
            <h3 class="text-3xl font-black text-blue-500"><?php echo e($stats['diproses']); ?></h3>
        ...
        <div class="bg-white p-8 rounded-xl shadow-sm border border-slate-50 flex flex-col items-center text-center group hover:shadow-md transition">
            ...
            <h3 class="text-3xl font-black text-indigo-500"><?php echo e($stats['selesai']); ?></h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="space-y-4">
            ...
            <div class="space-y-4">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $permohonanBaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 hover:border-blue-300 transition-all group relative overflow-hidden">
                        ...
                        <div class="flex justify-between items-start mb-3">
                            <a href="<?php echo e(route('admin.permohonan.show', $item->id)); ?>" class="text-blue-600 font-black text-[11px] uppercase tracking-wider hover:underline">
                        ...
                        <p class="text-[10px] text-slate-500 italic line-clamp-1 mb-4">
                            "<?php echo e($item->rincian_informasi); ?>"
                        </p>
                        ...
                        <div class="flex justify-between items-center pt-4 border-t border-slate-50">
                            ...
                            <a href="<?php echo e(route('admin.permohonan.show', $item->id)); ?>" class="text-[10px] font-black text-slate-400 group-hover:text-blue-600 transition-colors uppercase tracking-widest">
                                Detail &rarr;
                            </a>
                        </div>
                    </div>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-xs border border-slate-100">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php $__currentLoopData = $permohonans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-slate-50 transition">
                                
                                <td class="px-4 py-3 border border-slate-100 text-center font-bold">
                                    <?php echo e($permohonans->firstItem() + $index); ?>

                                </td>
                                
                                
                                <td class="px-4 py-3 border border-slate-100">
                                    <a href="<?php echo e(route('admin.permohonan.show', $p->id)); ?>" class="text-blue-600 font-bold hover:underline">
                                ...
                                <td class="px-4 py-3 border border-slate-100 text-center">
                                    <form action="<?php echo e(route('admin.permohonan.destroy', $p->id)); ?>" method="POST" id="delete-form-<?php echo e($p->id); ?>" class="inline">
                                        <?php echo csrf_field(); ?>
                ...
                <div class="mt-4 flex justify-between items-center text-xs text-slate-500 italic">
                    <p>Showing <?php echo e($permohonans->firstItem()); ?> to <?php echo e($permohonans->lastItem()); ?> of <?php echo e($permohonans->total()); ?> entries</p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/permohonan/index.blade.php ENDPATH**/ ?>